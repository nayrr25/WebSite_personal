...
// Titulares — Archivo (variable, pesos hasta 900). Expuesta como --font-display;
// la consumen las utilidades .text-display-*/.text-h* en globals.css.
...
// Acento itálico ocasional — Instrument Serif. Expuesta como --font-serif.
...
export const viewport: Viewport = {
  // OPCIÓN C · tema claro — el chrome del navegador acompaña al fondo slate claro.
  themeColor: "#F3F5F9",
  colorScheme: "light",
  width: "device-width",
  initialScale: 1,
